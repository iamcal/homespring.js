describe("keyword: youth fountain", function(){

	// Makes all salmon young.

	it("makes all salmon young", function(){

		var p = new HS.Program('foo youth. fountain bar');
