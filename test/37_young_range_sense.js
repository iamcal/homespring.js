describe("keyword: young range sense", function(){
	...
	it("blocks electicity with mixed salmon", function(){
		...
		p.tick();
		p.findFirstNode('young range sense').fishEnters(s1);
		p.findFirstNode('young range sense').fishEnters(s2);
